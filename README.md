...
* 在你的module的根目录下的**build.gradle**添加依赖
	```
	<!--这里的版本号，0.6.4-beta4 可以指定为任意release版本-->
	<!--如果希望一直使用最新版本可以替换 0.6.4-beta4 为 master-SNAPSHOT -->
	dependencies {
	        ...
	        compile 'com.github.YolandaQingniu:qnscalesdk:0.6.4-beta4'
	}
	```
	
### Eclipse
* 下载最新的[jar和so库](https://github.com/YolandaQingniu/qnscalesdk/releases/download/0.6.4-beta4/qnsdk-0.6.4-beta4-Android.zip)，导入下载的`jar和so库`
