...
* 在你的module的根目录下的**build.gradle**添加依赖
	```
	<!--这里的版本号，2.2.0-beta4可以指定为任意release版本-->
	<!--如果希望一直使用最新版本可以替换 2.2.0-beta4 master-SNAPSHOT -->
	dependencies {
	        ...
	        compile 'com.github.YolandaQingniu:qnscalesdk:2.2.0-beta4'
	}
	```
	
### Eclipse
* 下载最新的[jar和so库](https://github.com/YolandaQingniu/qnscalesdk/releases/download/2.2.0-beta4/qnsdk-2.2.0-beta4-Android.zip)，导入下载的`jar和so库`
